...
async function runJailbreak(uncapSdk = false) {
    ...
    setTimeout(async () => {
        ...
        if (wk_exploit_type == LOCALSTORE_WK_EXPLOIT_TYPE_VALUE_FONTFACE) {
            await run_fontface(uncapSdk);
        } else if (wk_exploit_type == LOCALSTORE_WK_EXPLOIT_TYPE_VALUE_PSFREE) {
            await run_psfree(uncapSdk);
        } else {
...
function onload_setup() {
    ...
    if (wk_exploit_type == null || (wk_exploit_type != LOCALSTORE_WK_EXPLOIT_TYPE_VALUE_FONTFACE && wk_exploit_type != LOCALSTORE_WK_EXPLOIT_TYPE_VALUE_PSFREE)) {
        wk_exploit_type = LOCALSTORE_WK_EXPLOIT_TYPE_VALUE_FONTFACE;
